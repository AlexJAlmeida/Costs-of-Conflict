...
% Show some results
% Discuss the difference in differences approach as well using portfolios.
% Compare with other methods
% List settings in which it has been used and new developments

% Dummy slide to cite something
\begin{frame}{Dummy}
